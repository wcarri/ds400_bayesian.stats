...
![](Screen%20Shot%202024-08-30%20at%205.11.36%20PM.png)

![](Screen%20Shot%202024-08-30%20at%205.11.51%20PM.png)
...
```{r}
## in class notes: (note: my mac was down)

prior_probability_article_fake  = 1 # ?
likelihood_article_fake_has_exc = 1 # ?
prior_probability_has_exc = 1       # ?
...
<!-- -->
```
-   Letting M denote the person is from the mid-west

    -   P(M) = ?

```{r}
## student work space below:
